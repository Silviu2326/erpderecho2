...
exports.oficioService = void 0;
const database_1 = require("../config/database");
const base_types_1 = require("./base.types");
class OficioService {
    constructor() {
        this.plantillasBase = new Map([
            ['DEMANDA', {
                    titulo: 'Demanda',
                    tipo: 'DEMANDA',
...
Abogado - Colegiado nº {{numero_colegiado}}`
    ...
    async getPlantillaById(id) {
        ...
        if (!plantilla) {
            throw new base_types_1.ServiceException('PLANTILLA_NOT_FOUND', 'Plantilla no encontrada', 404);
        }
        return { id, ...plantilla };
    }
    ...
    async findAllDocumentos(params) {
    ...
    async createDocumento(usuarioId, input) {
    ...
    async updateDocumento(id, input) {
    ...
    async saveGeneratedDocument(usuarioId, expedienteId, nombre, tipo, contenido) {
        const documento = await database_1.prisma.documento.create({
            data: {
                nombre,
                tipo,
...
exports.oficioService = new OficioService();
//# sourceMappingURL=oficio.service.js.map