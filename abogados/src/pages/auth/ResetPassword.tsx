...
import { 
  Scale, Lock, Eye, EyeOff, ArrowLeft, CheckCircle, ArrowRight,
  AlertCircle
} from 'lucide-react';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 overflow-y-auto relative">
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold text-theme-primary mb-2">Nueva contraseña</h1>
          ...
          {success ? (
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-emerald-500 mb-2">Contraseña actualizada</h3>
                  ...
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      ...
                      className={`h-1 flex-1 rounded-full ${
                        password.length >= i * 2 ? 'bg-emerald-500' : 'bg-theme'
                      }`}
                    />
                  ))}
                </div>
